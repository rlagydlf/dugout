              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [
                    ...
                    DTokens.bgDark.withValues(alpha: 0.90),
                    DTokens.bgDark,
                  ],
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '계속 진행 시 약관 및 개인정보 처리방침에 동의합니다.',
                    textAlign: TextAlign.center,
                    style: DType.micro(11,
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        Text(
          'DUGOUT',
          style: DType.impact(24, color: Colors.white, letterSpacing: 6),
        ),
      ],
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Text(
          '더그아웃에\n오신 걸\n환영합니다',
          style: DType.heading(40, color: Colors.white),
        )
            .animate()
