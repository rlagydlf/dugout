              ...
              delegate: SliverChildBuilderDelegate(
                (ctx, i) {
                  ...
                  return Padding(
                    ...
                    child: _QuestCard(quest: q, onTap: () => context.push('/quests/${q.id}'))
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: team.primary.withValues(alpha: 0.2), blurRadius: 24, offset: const Offset(0, 8)),
        ],
      ),
      child: Container(
        height: 8,
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: isSelected
                    ? [BoxShadow(color: team.primary.withValues(alpha: 0.4), blurRadius: 8)]
                    : null,
              ),
              child: Text(
                _labels[type]!,
      ...
      child: Opacity(
        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                ...
                if (isDone)
                  ...
                  Container(
                    ...
                    child: Text('+${quest.reward} P', style: DType.mono(12, color: DTokens.warning)),
                  ),
              ],
            ),
            ...
            Text(quest.description, style: DType.body(14).copyWith(color: DTokens.textTertiaryDark)),
              ...
              Row(
                children: [
                  Expanded(
                    child: Stack(
                      children: [
                        Container(height: 5, decoration: BoxDecoration(color: DTokens.borderDark, borderRadius: BorderRadius.circular(DTokens.rPill))),
                        FractionallySizedBox(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: team.primary,
                              borderRadius: BorderRadius.circular(DTokens.rPill),
                              boxShadow: [BoxShadow(color: team.primary.withValues(alpha: 0.5), blurRadius: 6)],
                            ),
                          ),
                        ),
                      ],
