...
class _NotiSettings {
  ...
  _NotiSettings copyWith({
    bool? pushEnabled, bool? inAppEnabled, bool? emailEnabled,
    bool? sortieReminder, bool? predictionDeadline, bool? settlement, bool? reward,
  }) => _NotiSettings(
...
class _State extends ConsumerState<NotificationsSettingsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('알림 수신 설정')),
      body: ListView(
        ...
        children: [
            ...
            child: Column(
              children: [
                ...
                _ToggleTile(
                  ...
                  onChanged: (v) => setState(() => _s = _s.copyWith(inAppEnabled: v)),
                ),
                _Divider(),
                _ToggleTile(
            ...
            child: Column(
              children: [
                _ToggleTile(
                  ...
                  onChanged: (v) => setState(() => _s = _s.copyWith(sortieReminder: v)),
                ),
                _Divider(),
                _ToggleTile(
                  ...
                  onChanged: (v) => setState(() => _s = _s.copyWith(predictionDeadline: v)),
                ),
                _Divider(),
                _ToggleTile(
                  ...
                  value: _s.settlement,
                  onChanged: (v) => setState(() => _s = _s.copyWith(settlement: v)),
                ),
                _Divider(),
                _ToggleTile(
                  ...
                  value: _s.reward,
                  onChanged: (v) => setState(() => _s = _s.copyWith(reward: v)),
                ),
              ],
            ),
          ...
          Container(
            ...
            child: Row(
              children: [
                const Icon(Icons.info_outline_rounded, size: 14, color: DTokens.textTertiaryDark),
                const SizedBox(width: DTokens.s8),
                Expanded(
                  child: Text(
                    '기기 설정 > 더그아웃에서 알림을 허용해야 푸시 알림을 받을 수 있습니다.',
                    style: DType.label(12, color: DTokens.textTertiaryDark).copyWith(height: 1.5),
                  ),
                ),
              ],
            ),
...
class _SectionLabel extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) =>
      Text(text, style: DType.body(15, FontWeight.w700).copyWith(color: DTokens.textSecondaryDark));
}

class _Divider extends StatelessWidget {
  @override
  Widget build(BuildContext context) =>
      const Divider(color: DTokens.borderDark, height: 1, indent: 56);
}
...
class _ToggleTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final team = context.team;
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: DTokens.s4),
      child: Row(
        children: [
          Container(
            width: 40,
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(title, style: DType.body(15, FontWeight.w600).copyWith(color: DTokens.textPrimaryDark)),
                Text(subtitle, style: DType.label(12, color: DTokens.textTertiaryDark)),
              ],
            ),
          ),
          Switch(
